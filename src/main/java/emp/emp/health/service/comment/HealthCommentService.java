...
public interface HealthCommentService {
	 ...
	 * @return AI 통계 요약
	 */
	String getAiComment(int year, int month, int week, Type type, List<HealthRecordGraphRes> data, Member member);
	 ...
	 * @return AI 통계 요약
	 */
	String getAiComment(int year, int month, Type type, List<HealthRecordGraphRes> data, Member member);
}
