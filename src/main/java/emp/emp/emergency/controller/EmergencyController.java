...
public class EmergencyController {
    ...
    public List<EmergencyRoomDTO> emergencyRoom(@RequestParam double userLatitude, @RequestParam double userLongitude) throws IOException, JAXBException { // 사용자의 위도 경도를 받아 서비스 계층에 넘긴다
